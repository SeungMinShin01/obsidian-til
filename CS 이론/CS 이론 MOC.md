...
| --- | --- |
| 트랜잭션 부재·경쟁 상태, 커넥션 풀 | [[SQL day01 데이터베이스 기초]] |
| game_likes UNIQUE, 업서트, 스키마 원본 부재 | [[SQL day02 테이블과 제약조건]] |
| 구간 겹침 WHERE, 바인딩·인젝션, JOIN 조회 | [[SQL day03 DML과 조인]] |
| TOP3 정렬, LIMIT 페이징, N+1의 GROUP BY 해법 | [[SQL day04 집계와 정렬]] |
...
| 05 | [[SQL day05 외래키 CASCADE와 조인]] | FK 참조 무결성, ON UPDATE/DELETE CASCADE, INNER/OUTER JOIN, UNION·차집합, 미니프로젝트 스키마 설계 |
