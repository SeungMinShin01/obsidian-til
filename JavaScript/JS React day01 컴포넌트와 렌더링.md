...
[[JS day14 게시판 CRUD]]에서 `list()` 함수가 매번 `innerHTML`을 통째로 다시 만들던 것을 떠올리면, React는 그 "다시 만들기"를 라이브러리가 대신하되 **바뀐 부분만** 갈아 끼운다(가상 DOM·재조정).
...
[[JavaScript MOC]] · [[JS day14 게시판 CRUD]] · [[KDT_2026 학습 지도]]
