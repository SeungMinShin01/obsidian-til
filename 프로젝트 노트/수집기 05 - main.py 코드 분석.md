...
> 허브: [[수집기 프로젝트 MOC]]
> 세부: [[수집기 05-1 - 파이썬 문법 세부]] · [[수집기 05-2 - now_utc 함수 분석]] · [[수집기 05-3 - append_run_log 함수 분석]]
...
이것이 **멱등성**이다. 몇 번을 실행해도 같은 결과가 나오고 터지지 않는 것, 무인 시스템의 기본 조건이다.
...
[[수집기 프로젝트 MOC]] · [[수집기 04 - 저장소에 결과 남기기]] · [[수집기 05-1 - 파이썬 문법 세부]] · [[수집기 05-2 - now_utc 함수 분석]] · [[수집기 05-3 - append_run_log 함수 분석]]
